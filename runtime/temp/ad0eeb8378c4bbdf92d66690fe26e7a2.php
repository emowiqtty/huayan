<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:55:"F:\web\huayan/application/user/view/admin/role\add.html";i:1489042525;s:48:"F:\web\huayan/application/admin/view/layout.html";i:1496481965;s:46:"./application/common/builder/aside/layout.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/recent.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/online.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/switch.html";i:1489042525;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="block block-bordered">
                                <div class="block-header bg-gray-lighter auth-node-top">
                                    <label class="css-input css-checkbox css-checkbox-primary">
                                        <input type="checkbox" name="menu_auth[]" value="<?php echo $menu['id']; ?>" class="js-check-all-node"><span></span> <i class="<?php echo $menu['icon']; ?>"></i> <?php echo $menu['title']; ?>
                                    </label>
                                </div>
                                <div class="block-content">
                                    ...
                                    <div class="auth-node-parent">
                                        <div>
                                            <label class="css-input css-checkbox css-checkbox-primary">
                                                <input type="checkbox" name="menu_auth[]" data-parent-id="<?php echo $menu['id']; ?>" value="<?php echo $submenu['id']; ?>" class="js-check-all-group"><span></span> <i class="<?php echo $submenu['icon']; ?>"></i> <?php echo $submenu['title']; ?>
                                            </label>
                                        </div>
                                        ...
                                        <div class="auth-node-child">
                                            ...
                                            <div class="auth-node-row">
                                                <label class="css-input css-checkbox css-checkbox-primary">
                                                    <input type="checkbox" name="menu_auth[]" data-parent-id="<?php echo $submenu['id']; ?>" value="<?php echo $submenu2['id']; ?>" class="js-check-all-row"><span></span> <i class="<?php echo $submenu2['icon']; ?>"></i> <?php echo $submenu2['title']; ?>
                                                </label>
                                                ...
                                                <div class="auth-node-child">
                                                    ...
                                                    <label class="css-input css-checkbox css-checkbox-primary push-10-r">
                                                        <input type="checkbox" name="menu_auth[]" data-parent-id="<?php echo $submenu2['id']; ?>" value="<?php echo $submenu3['id']; ?>"><span></span> <?php echo $submenu3['title']; ?>
                                                    </label>
                                                    <?php endforeach; ?>
                                                </div>
                                                <?php endif; ?>
