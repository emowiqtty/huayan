<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:59:"F:\web\huayan/application/huayan/view/admin/index\edit.html";i:1497585469;s:48:"F:\web\huayan/application/admin/view/layout.html";i:1496481965;s:46:"./application/common/builder/aside/layout.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/recent.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/online.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/switch.html";i:1489042525;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="block-content">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="ribbon-box font-w600 text-uppercase">2017年6月14日</div>
                        <div class="text-center push-50-t push-50">
                        <!-- <h3 class="text-white-op">水质检测数据填报</h3> -->
                        <div class="block-content block-content-full text-center">
                            <div>
                            <img class="img-avatar img-avatar96" src="<?php echo $avatar; ?>" alt="">
                            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="<?php echo url('index/edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" id="waterTemperatureYs" name="waterTemperatureYs" value="<?php echo $info['waterTemperatureYs']; ?>">
                                <span class="input-group-addon">°C</span>
                            </div>
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <div class="input-group">
                                <input class="form-control" type="text" id="waterTemperatureCcs" name="waterTemperatureCcs" value="<?php echo $info['waterTemperatureCcs']; ?>">
                                <span class="input-group-addon">°C</span>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="chromaYs" name="chromaYs" value="<?php echo $info['chromaYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <div class="input-group">
                            <span class="input-group-addon"><</span>
                                <input class="form-control" type="text" id="chromaCcs" name="chromaCcs" value="<?php echo $info['chromaCcs']; ?>">
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-sm-offset-1">
                                ...
                                <input type="radio" name="eyeYs" value="1" <?php if($info['eyeYs'] == 1): ?> checked="checked" <?php endif; ?>><span></span> 有
                                </label>
                                <label class="css-input css-radio css-radio-primary">
                                <input type="radio" name="eyeYs" value="0" <?php if($info['eyeYs'] == 0): ?> checked="checked" <?php endif; ?>><span></span> 无
                                </label>
                            </div>
                            <div class="col-sm-1 col-sm-offset-3">
                                <label class="css-input css-radio css-radio-primary push-10-r">
                                <input type="radio" name="eyeCcs" checked="" value="1" <?php if($info['eyeCcs'] == 1): ?> checked="checked" <?php endif; ?>><span></span> 有
                                </label>
                                <label class="css-input css-radio css-radio-primary">
                                <input type="radio" name="eyeCcs" value="0" <?php if($info['eyeCcs'] == 0): ?> checked="checked" <?php endif; ?>><span></span> 无
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-sm-offset-1">
                                <label class="css-input css-radio css-radio-primary push-10-r">
                                <input type="radio" name="smellYs" checked="" value="1" <?php if($info['smellYs'] == 1): ?> checked="checked" <?php endif; ?>><span></span> 有
                                </label>
                                <label class="css-input css-radio css-radio-primary">
                                <input type="radio" name="smellYs" value="0" <?php if($info['smellYs'] == 0): ?> checked="checked" <?php endif; ?>><span></span> 无
                                </label>
                            </div>
                            <div class="col-sm-1 col-sm-offset-3">
                                <label class="css-input css-radio css-radio-primary push-10-r">
                                <input type="radio" name="smellCcs" checked="" value="1" <?php if($info['smellCcs'] == 1): ?> checked="checked" <?php endif; ?>><span></span> 有
                                </label>
                                <label class="css-input css-radio css-radio-primary">
                                <input type="radio" name="smellCcs" value="0" <?php if($info['smellCcs'] == 0): ?> checked="checked" <?php endif; ?>><span></span> 无
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="phYs" name="phYs" value="<?php echo $info['phYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="phCcs" name="phCcs" value="<?php echo $info['phCcs']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="oxygenYs" name="oxygenYs" value="<?php echo $info['oxygenYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="oxygenCcs" name="oxygenCcs" value="<?php echo $info['oxygenCcs']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="ammoniaYs" name="ammoniaYs" value="<?php echo $info['ammoniaYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <div class="input-group">
                            <span class="input-group-addon"><</span>
                                <input class="form-control" type="text" id="ammoniaCcs" name="ammoniaCcs" value="<?php echo $info['ammoniaCcs']; ?>">
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="colonyYs" name="colonyYs" value="<?php echo $info['colonyYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="colonyCcs" name="colonyCcs" value="<?php echo $info['colonyCcs']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="totalColiformYs" name="totalColiformYs" value="<?php echo $info['totalColiformYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="totalColiformCcs" name="totalColiformCcs" value="<?php echo $info['totalColiformCcs']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="thermotolerantColiformYs" name="thermotolerantColiformYs" value="<?php echo $info['thermotolerantColiformYs']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="thermotolerantColiformCcs" name="thermotolerantColiformCcs" value="<?php echo $info['thermotolerantColiformCcs']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="samplingCcsYl" name="samplingCcsYl" value="<?php echo $info['samplingCcsYl']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-sm-offset-1">
                            <input class="form-control" type="text" id="samplingYsZd" name="samplingYsZd" value="<?php echo $info['samplingYsZd']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-4">
                            <input class="form-control" type="text" id="samplingCcsZd" name="samplingCcsZd" value="<?php echo $info['samplingCcsZd']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-1 col-sm-offset-101">
                            <input class="js-masked-time form-control" type="text" id="example-masked-time" name="time[]" value="<?php echo $vo['time']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-101">
                            <input class="form-control" type="text" id="simple-classic-progress-firstname" name="ccseyhl[]" value="<?php echo $vo['ccseyhl']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-101">
                            <input class="form-control" type="text" id="simple-classic-progress-firstname" name="ccszd[]" value="<?php echo $vo['ccszd']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-101">
                            <input class="form-control" type="text" id="simple-classic-progress-firstname" name="yszd[]" value="<?php echo $vo['yszd']; ?>">
                            </div>
                            <div class="col-sm-1 col-sm-offset-101">
                            <input class="form-control" type="text" id="simple-classic-progress-firstname" name="lqzd[]" value="<?php echo $vo['lqzd']; ?>">
                            </div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div class="form-group" id="abc">
                            <div class="col-sm-1 col-sm-offset-101">
                                <button class="btn btn-primary push-5-r push-10" id="addtable" type="button" onclick="addCol()"><i class="fa fa-plus"></i> 添加一行 </button>
                            </div>
                            <div class="col-sm-1 col-sm-offset-101">
                                <button class="btn btn-danger push-5-r push-10" id="addtable" type="button" onclick="delCol()"><i class="fa fa-times"></i> 删除一行 </button>
                            </div>
                        </div>
                    ...
                    　　　　}　
                        ...
                        <textarea class="form-control" name="beizhu" rows="6" placeholder="填写备注.."><?php echo $info['beizhu']; ?></textarea>
                        </div>
                        </div>
